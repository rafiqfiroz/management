         ...
         <div class="row">
             ...
             <div class="col-md-8">
                 <div class=""  style="border:1px solid black;padding:10px;margin-top:10px">
                     <div class="card-body">
                         <h3 style="text-align:center;text-decoration:underline">Edit Department</h3>
                         <router-link to="all_category" style="float:right" class="btn btn-success btn-sm">Manage Department</router-link>
...
export default {
    ...
    methods: {
        ...
        UpdateCategory(){
         this.form.post('/api/auth/department-update')
         .then((result) => {
        ...
        EditDepartment(){
            axios.get('/api/auth/department-edit/'+this.$route.params.id)
            .then((result) => [
